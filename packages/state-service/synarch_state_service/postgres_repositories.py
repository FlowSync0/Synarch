...
def build_postgres_repositories(database_url: str) -> StateRepositories:
    return StateRepositories(
        ...
        agent_lifecycle_requests=PostgresRecordRepository(
            ...
            frozenset({"proposed_agent", "proposed_soul"}),
        ),
        credential_access_requests=PostgresRecordRepository(
            database_url,
        ...
        human_assistance_requests=PostgresRecordRepository(
            database_url,
        ...
        credential_grants=PostgresRecordRepository(
            database_url,
            "credential_grants",
            CredentialGrant,
            (
        ...
        connector_connections=PostgresRecordRepository(
            database_url,
        ...
        connector_jobs=PostgresRecordRepository(
            database_url,
            "connector_jobs",
            ConnectorJobRecord,
            (
        ...
        connector_job_runs=PostgresRecordRepository(
            database_url,
            "connector_job_runs",
            ConnectorJobRunRecord,
            (
        ...
        work_queue_items=PostgresRecordRepository(
            database_url,
            "work_queue_items",
            WorkQueueItem,
            (
