    ...
    return [
        ModelMessage(
            ...
            content=(
                ...
                "If you hit CAPTCHA, a login/manual action, an ambiguous external error, "
                "a PDF or document that needs human verification, or a key business "
                "decision, request human.assistance.request with kind captcha, "
                "pdf_review, error_resolution, key_decision, manual_action, or other; "
                "arguments must include title, description, urgency, and evidence. "
                "If task.result.last_human_assistance_resolution exists, treat it as "
                "fresh human input for this retry; do not request the same human "
                "assistance again unless the response is insufficient or a new blocker appears. "
