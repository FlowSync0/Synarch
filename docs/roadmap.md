...
| G. Execution & Tooling | Partial | `ToolCallRequest`, `ToolResult`, and gateway permission gate exist. | No real external tool adapters, sandbox execution, cron, or webhook runner yet. | Denied tool call fails before execution and records audit/event. |
